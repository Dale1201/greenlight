...
import (
	...
	"github.com/Dale1201/greenlight/internal/data"
	"github.com/Dale1201/greenlight/internal/validator"
)
...
func (app *application) updateMovieHandler(w http.ResponseWriter, r *http.Request) {
	// Extract the ID of the movie from the URL parameters
	id, err := app.readIDParam(r)
	if err != nil {
		app.notFoundResponse(w, r)
		return
	...
	// Return a JSON response containing the updated movie record
	err = app.writeJSON(w, http.StatusOK, envelope{"movie": movie}, nil)
	if err != nil {
		app.serverErrorResponse(w, r, err)
	}
